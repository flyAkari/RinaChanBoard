package top.flyakari.rinachanboardcontroller.udp;
...
public class UdpClientConnector {
    private static final String TAG = "UdpClientConnector";
...
//    };
    ...
    public void createConnector(final String ip, final int port, final int timeOut) {
        if (mSendThread == null) {
                ...
                public void run() {
                    while (true) {
                        ...
                        try {
                            ...
                            byte[] data = mSendHexString.getBytes(StandardCharsets.UTF_8);
            ...
            Log.i(TAG, "mSendThread is not null");
        }
    }
